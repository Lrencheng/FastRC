...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED1_Pin|LED2_Pin|LED3_Pin|GPIO6_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPIO1_Pin|GPIO2_Pin|GPIO3_Pin|GPIO4_Pin
                          |GPIO4C4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED1_Pin LED2_Pin LED3_Pin GPIO4C4_Pin */
  GPIO_InitStruct.Pin = LED1_Pin|LED2_Pin|LED3_Pin|GPIO4C4_Pin;
